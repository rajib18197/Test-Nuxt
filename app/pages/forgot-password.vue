<template>
    <div class="flex justify-center items-center min-h-screen bg-gray-100">
      ...
      <div class="w-full max-w-2xl bg-white rounded-lg shadow-lg p-12">
        <h1 class="text-3xl font-bold text-center text-gray-800">Forgot Password</h1>
        <p class="text-lg text-gray-600 text-center mt-4">
          Enter your email address below and we'll send you a link to reset your password.
        </p>
        <form @submit.prevent="handleSubmit" class="mt-8">
          <div class="mb-6">
            <label for="email" class="block text-lg font-medium text-gray-700">User ID or Email</label>
            <input
              id="email"
              v-model="email"
              type="email"
